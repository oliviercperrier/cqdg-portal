...
const Exome = ({ className }: IClassNameProp): React.ReactElement => (
    <svg
        className={className}
        fill="none"
        height="48"
    ...
    >
        <path
            d="M48 32.25C48 40.9478 40.9492 48 32.25 48C23.5507 48 16.5 40.9478 16.5 32.25C16.5 23.547 23.5507 16.5 32.25 16.5C40.9492 16.5 48 23.547 48 32.25Z"
            fill="#C2ECFB"
        />
        <path
            clipRule="evenodd"
        ...
        <path
            clipRule="evenodd"
            d="M9.69099 41.3645C13.58 44.5735 18.5644 46.5 23.9999 46.5V48C18.2034 48 12.8843 45.944 8.73633 42.5215L9.69099 41.3645Z"
            fill="#486F90"
            fillRule="evenodd"
        />
        <path
            clipRule="evenodd"
            d="M24.0002 43.5C28.6245 43.5 32.8715 41.8906 36.2142 39.2023L37.1542 40.3712C33.5549 43.2659 28.9788 45 24.0002 45C20.0153 45 16.2871 43.8893 13.1123 41.9608L13.8911 40.6788C16.8378 42.4687 20.2976 43.5 24.0002 43.5Z"
            fill="#486F90"
            fillRule="evenodd"
        />
        <path
            clipRule="evenodd"
            d="M43.5001 24C43.5001 21.4471 43.0096 19.0115 42.1194 16.7777L43.5128 16.2224C44.4721 18.6295 45.0001 21.2534 45.0001 24C45.0001 28.9577 43.2808 33.5158 40.4079 37.1089L39.2363 36.1721C41.9044 32.8352 43.5001 28.6048 43.5001 24Z"
            fill="#486F90"
            fillRule="evenodd"
        />
        <path
        ...
        <path
            clipRule="evenodd"
            d="M9.63446 15.8776C8.27551 18.2749 7.5 21.0459 7.5 24C7.5 33.113 14.887 40.5 24 40.5C26.6975 40.5 29.2412 39.8542 31.4871 38.7091L32.1684 40.0454C29.7163 41.2957 26.9395 42 24 42C14.0585 42 6 33.9414 6 24C6 20.7801 6.84599 17.755 8.32954 15.1379L9.63446 15.8776Z"
            fill="#486F90"
            fillRule="evenodd"
        />
        <path
            clipRule="evenodd"
            d="M23.9998 10.5C21.2028 10.5 18.6063 11.3496 16.4524 12.8045L15.6128 11.5615C18.0069 9.94436 20.8944 9 23.9998 9C30.1597 9 35.4507 12.7126 37.7601 18.0203L36.3846 18.6187C34.3049 13.8389 29.5415 10.5 23.9998 10.5Z"
            fill="#486F90"
            fillRule="evenodd"
        />
        <path
            clipRule="evenodd"
            d="M13.3774 15.6672C11.5746 17.9632 10.5 20.8545 10.5 24C10.5 25.4928 10.7417 26.9264 11.1876 28.2662L9.76437 28.7399C9.26828 27.2492 9 25.6558 9 24C9 20.5066 10.1949 17.2914 12.1976 14.7408L13.3774 15.6672Z"
            fill="#486F90"
            fillRule="evenodd"
        />
        <path
            clipRule="evenodd"
            d="M24 37.5C29.6993 37.5 34.5766 33.9663 36.5567 28.9685L37.9513 29.521C35.7524 35.0712 30.3352 39 24 39V37.5Z"
            fill="#486F90"
            fillRule="evenodd"
        />
        <path
