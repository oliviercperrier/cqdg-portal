...
const Storage = ({ className = '' }: IClassNameProp): React.ReactElement => (
    ...
    >
        ...
        <path
            ...
            fillRule="evenodd"
        />
        <path clipRule="evenodd" d="M3.09375 13.7812H3.65625V14.3438H3.09375V13.7812Z" fillRule="evenodd" />
        <path clipRule="evenodd" d="M14.3438 13.7812H14.9062V14.3438H14.3438V13.7812Z" fillRule="evenodd" />
        <path clipRule="evenodd" d="M11.5312 14.3438H6.46875V13.7812H11.5312V14.3438Z" fillRule="evenodd" />
        <path clipRule="evenodd" d="M13.2188 2.25H10.4062V1.6875H13.2188V2.25Z" fillRule="evenodd" />
        <path clipRule="evenodd" d="M13.2188 3.375H4.78125V2.8125H13.2188V3.375Z" fillRule="evenodd" />
    </svg>
);
