...
const Donor: React.FC<IICon> = ({ className = '', colored = true, size = 48 }) => (
    ...
    >
        <path clipRule="evenodd" d="M24.75 32.25V48H23.25V32.25H24.75Z" fillRule="evenodd" />
        <path
            clipRule="evenodd"
        ...
        <path
            ...
            fillRule="evenodd"
        />
        <path clipRule="evenodd" d="M12 35.25V48H10.5V35.25H12Z" fillRule="evenodd" />
        <path
            clipRule="evenodd"
        ...
        <path
            ...
            fillRule="evenodd"
        />
        <path clipRule="evenodd" d="M37.5 35.25V48H36V35.25H37.5Z" fillRule="evenodd" />
        <path
            clipRule="evenodd"
        ...
        <path
            ...
            fillRule="evenodd"
        />
        <path clipRule="evenodd" d="M23.25 15V13.5H24.75V15H23.25Z" fillRule="evenodd" />
        <path clipRule="evenodd" d="M23.25 18V16.5H24.75V18H23.25Z" fillRule="evenodd" />
        <path clipRule="evenodd" d="M36 20.25V18.75H37.5V20.25H36Z" fillRule="evenodd" />
        <path clipRule="evenodd" d="M10.5 20.25V18.75H12V20.25H10.5Z" fillRule="evenodd" />
        <path clipRule="evenodd" d="M18 48V33H19.5V48H18Z" fillRule="evenodd" />
        <path clipRule="evenodd" d="M28.5 48V33H30V48H28.5Z" fillRule="evenodd" />
    </svg>
);
