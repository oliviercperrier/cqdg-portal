...
const Donor = ({ className }: IClassNameProp): React.ReactElement => (
    <svg
        className={className}
        fill="none"
        height="48"
    ...
    >
        <path
            d="M18.75 31.5C27.4485 31.5 34.5 24.4485 34.5 15.75C34.5 7.05152 27.4485 0 18.75 0C10.0515 0 3 7.05152 3 15.75C3 24.4485 10.0515 31.5 18.75 31.5Z"
            fill="#C2ECFB"
        />
        <path clipRule="evenodd" d="M24.75 32.25V48H23.25V32.25H24.75Z" fill="#486F90" fillRule="evenodd" />
        <path
            clipRule="evenodd"
        ...
        <path
            ...
            fillRule="evenodd"
        />
        <path clipRule="evenodd" d="M12 35.25V48H10.5V35.25H12Z" fill="#486F90" fillRule="evenodd" />
        <path
            clipRule="evenodd"
        ...
        <path
            ...
            fillRule="evenodd"
        />
        <path clipRule="evenodd" d="M37.5 35.25V48H36V35.25H37.5Z" fill="#486F90" fillRule="evenodd" />
        <path
            clipRule="evenodd"
        ...
        <path
            ...
            fillRule="evenodd"
        />
        <path clipRule="evenodd" d="M23.25 15V13.5H24.75V15H23.25Z" fill="#486F90" fillRule="evenodd" />
        <path clipRule="evenodd" d="M23.25 18V16.5H24.75V18H23.25Z" fill="#486F90" fillRule="evenodd" />
        <path clipRule="evenodd" d="M36 20.25V18.75H37.5V20.25H36Z" fill="#486F90" fillRule="evenodd" />
        <path clipRule="evenodd" d="M10.5 20.25V18.75H12V20.25H10.5Z" fill="#486F90" fillRule="evenodd" />
        <path clipRule="evenodd" d="M18 48V33H19.5V48H18Z" fill="#486F90" fillRule="evenodd" />
        <path clipRule="evenodd" d="M28.5 48V33H30V48H28.5Z" fill="#486F90" fillRule="evenodd" />
    </svg>
);
