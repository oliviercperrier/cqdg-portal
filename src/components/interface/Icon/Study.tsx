...
const Study: React.FC<IICon> = ({ className = '', colored = true, size = 48 }) => (
    ...
    >
        ...
        <path
            ...
            fillRule="evenodd"
        />
        <path clipRule="evenodd" d="M8.25 12H39.75V15.75H38.25V13.5H9.75V15.75H8.25V12Z" fillRule="evenodd" />
        <path clipRule="evenodd" d="M6.75 17.25H41.25V20.25H39.75V18.75H8.25V20.25H6.75V17.25Z" fillRule="evenodd" />
        <path clipRule="evenodd" d="M5.25 21.75H42.75V25.5H41.25V23.25H6.75V25.5H5.25V21.75Z" fillRule="evenodd" />
        <path
            clipRule="evenodd"
            ...
            fillRule="evenodd"
        />
        <path clipRule="evenodd" d="M8.25 36.75H9.75V38.25H8.25V36.75Z" fillRule="evenodd" />
        <path clipRule="evenodd" d="M38.25 36.75H39.75V38.25H38.25V36.75Z" fillRule="evenodd" />
        <path clipRule="evenodd" d="M30.75 38.25H17.25V36.75H30.75V38.25Z" fillRule="evenodd" />
        <path clipRule="evenodd" d="M35.25 6H27.75V4.5H35.25V6Z" fillRule="evenodd" />
        <path clipRule="evenodd" d="M35.25 9H12.75V7.5H35.25V9Z" fillRule="evenodd" />
    </svg>
);
